...
pub const TracerProvider = struct {
    ...
    getTracerFn: *const fn (*anyopaque, []const u8, ?[]const u8, ?[]const u8, []attribute.Attribute) tracer.Tracer;
    ...
    pub fn getTracer(self: *Self, name: []const u8, version: ?[]const u8, schema_url: ?[]const u8, attributes: []Attribute) tracer.Tracer {
